...
describe('numeroEnComun(array1, array2)', function() {
    xit('Deberia retornar el numero en comun entre los arrays que recibe por parametro, en caso de no haber numero en comun de, devolver el numero mas pequeño', function() {
      expect(numeroEnComun([10, 15, 24], [2, 19, 10])).toBe(10);
      expect(numeroEnComun([2, 3, 15], [1, 4, 15])).toBe(15)
    });
    xit('Deberia retornar el numero mas chicho en caso de que no haya numeros en comun entre ambos arrays', function(){
